      ...
      <div className="contact4-max-width thq-section-max-width">
        <div className="contact4-section-title">
          ...
          <div className="contact4-content">
            ...
            <p className="contact4-text02 thq-body-large">{props.content1}</p>
          </div>
        </div>
          ...
          <div className="contact4-content1">
            ...
            <div className="contact4-contact-info">
              <div className="contact4-content2">
                ...
                <p className="contact4-text04 thq-body-large">
                  {props.content3}
                </p>
                <p className="contact4-text05 thq-body-large">
                  {props.content3}
                </p>
              </div>
          ...
          <div className="contact4-content3">
            ...
            <div className="contact4-contact-info1">
              <div className="contact4-content4">
                <h3 className="contact4-text06 thq-heading-3">Phone</h3>
                <p className="contact4-text07 thq-body-large">
                  {props.content4}
                </p>
              </div>
          ...
          <div className="contact4-content5">
            ...
            <div className="contact4-contact-info2">
              <div className="contact4-content6">
                <h3 className="contact4-text08 thq-heading-3">Office</h3>
                <p className="contact4-text09 thq-body-large">
                  {props.content5}
                </p>
              </div>
...
Contact4.defaultProps = {
  ...
  content5: 'Facebook, Instagram, Twitter',
  rootClassName: '',
  content1:
    "We'd love to hear from you. Feel free to reach out to us with any questions or inquiries.",
  content3: 'mmlsantiago@tip.edu.ph',
  content2:
    'For any support or assistance, please email us at support@fiitwell.com',
  address1: '123 Wellness Street, Fitness City, USA',
